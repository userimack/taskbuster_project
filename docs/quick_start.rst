...
The default language for this Project is **English**, and we use internationalization to translate the text into Hindi.
...
change the language "hi" for your selected language.
 
Next, go to the locale folder of your language::
 
    $ cd taskbuster/locale/hi/LC_MESSAGES
